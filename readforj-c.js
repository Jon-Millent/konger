(function(root){
	...
	var yings = ['阿','奕','资','矮','噢','咖','可以','哭','该','抠','仨','西','斯','腮','嗽','搭','期','俗','贷','都','拿','你','努','内','都哦','瓦','黑','福','耶','猴','麻','密','亩','没','谋','牙','与','悠','答','离','如','待','楼','哇','欧','鞥','嘎','机','姑','捏','购','咋','级','租','咧','邹','大','鸡','资','碟','都','吧','比','不','摆','博','啪','批','扑','撇','剖','恩','哈','匣','久'];
	...
	var chineseText = {
		...
		numbering : ['43,15,11','3,1','1,16','31,47','0,33','71','4','4,45','5','5','72,20','5,1','46,48','6','15,30','7','17','1,22','31','50','7,16','50','6,56,39','35,30','50','37','1,19','0,51','31,31','73','18','19,4','59','74']
	};
	var chineseTest = /^[\u4e00-\u9fa5]+$/;
	function Factory(){
		this.dataFactory={};
