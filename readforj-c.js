(function(root){
	...
	var yings = ['阿','奕','资','矮','噢','咖','可以','哭','该','抠','仨','西','斯','腮','嗽','搭','期','俗','贷','都','拿','你','努','内','都哦','哇','福','耶','猴','麻','密','亩','没','谋','牙','与','悠','答','离','如','待','楼','哇','欧','鞥','嘎','机','姑','捏','购','咋','级','租','咧','邹','大','鸡','资','碟','都','吧','比','不','摆','博','啪','批','扑','撇','剖'];
